...
map_datapoints <- readRDS(here::here("./data/map_datapoints.rds"))
map_datapoints
```
...
library(leaflet)  
map_datapoints_clustered <- readRDS(here::here("./data/map_datapoints_clustered.rds"))
...
map_datapoints_clustered_env <- readRDS(here::here("./data/map_datapoints_clustered_env.rds"))
